...
helm install proxyauthk8s oci://ghcr.io/batleforc/proxyauthk8s/chart-crd:__APP_VERSION__--namespace proxyauthk8s --create-namespace
# Install the latest version of ProxyAuthK8s
helm install proxyauthk8s oci://ghcr.io/batleforc/proxyauthk8s/chart:__APP_VERSION__ --namespace proxyauthk8s --values values.yaml
```
